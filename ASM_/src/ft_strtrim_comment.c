...
static void ft_delete_spaces(char const *s, size_t *index, char comment_char, char flg)
{
    if (flg == 1)
    {
...
static void ft_delete_comment(char const *s, size_t index, size_t *len, char comment_char)
{
    size_t i;
